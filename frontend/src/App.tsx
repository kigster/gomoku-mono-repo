...
export default function App() {
      ...
      .then((data) => {
        if (data)
          setStats({
            ...
            lost: data.games_lost ?? 0,
            bestScore: data.personal_best?.score ?? null,
          });
      })
      .catch(() => {});
  }, []);
    ...
    if (
      ...
      if (isFinishedGame && authToken && gameState) {
        fetch(`${API_BASE}/game/save`, {
          ...
          .catch((err) => {
            const detail =
              err instanceof Error ? err.message : "Unable to save game";
  ...
  const [showDifficultySettingsModal, setShowDifficultySettingsModal] =
    useState(false);
    ...
    <>
      ...
      {needsAuth ? (
        ...
        <div className="min-h-screen relative z-10">
            ...
            <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 mr-5">
                ...
                <div className="relative">
                  ...
                  {showNavMenu && (
                    <div
                      className="absolute top-full right-0 z-[1001] mt-1
          ...
          >
            <div className="game-panel rounded-2xl p-4 sm:p-8 max-w-6xl w-full text-neutral-100">
              <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 items-center lg:items-start justify-center">
                {/* Left panel: Settings */}
                {/* Side column width: 288px (lg:w-72) → 338px = +50px wider, per the
                    in-game chat density spec. Shared by SettingsPanel and ChatPanel
                    tabs so both gain the breathing room. */}
                <div className="w-full lg:w-[338px] shrink-0 flex flex-col">
                  <button

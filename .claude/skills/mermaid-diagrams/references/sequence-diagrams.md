...
1. **Use activations** - Shows when components are actively processing
1. **Group related logic** - Use alt/opt/par to organize conditional flows
1. **Add descriptive notes** - Explain complex logic or important details
1. **Keep diagrams focused** - One scenario per diagram
1. **Number messages** - Use autonumber for complex flows
1. **Show error paths** - Document failure scenarios with alt/else
1. **Indicate async operations** - Use open arrows for fire-and-forget messages

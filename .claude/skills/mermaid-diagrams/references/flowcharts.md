...
1. **Consistent node shapes** - Same shapes for same types of actions
1. **Decision nodes as diamonds** - Standard convention for yes/no decisions
1. **Flow top-to-bottom or left-to-right** - Natural reading direction
1. **Start and end nodes** - Use stadium/pill shapes to mark entry/exit
1. **Group related steps** - Use subgraphs for logical groupings
1. **Color code** - Use colors to highlight different types of actions
1. **Minimize crossing lines** - Reorganize for clarity
1. **Keep it focused** - One process per diagram

...
1. **Show only relevant details** - Omit obvious getters/setters unless important
1. **Use appropriate relationships** - Choose between association, aggregation, and composition carefully
1. **Add multiplicity** - Clarifies how many instances participate
1. **Group related classes** - Use notes or visual proximity
1. **Document invariants** - Use notes to explain business rules

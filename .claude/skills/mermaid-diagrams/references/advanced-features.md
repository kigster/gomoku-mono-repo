...
1. **Don't over-style** - Too many colors can reduce clarity
1. **Test hand-drawn look** - Some diagrams work better with classic look
1. **Use ELK for complex layouts** - When dagre creates crossed lines
1. **Comment complex configurations** - Explain non-obvious styling choices
1. **Keep it accessible** - Ensure sufficient color contrast
1. **Test exports** - Verify diagrams render correctly in target format
1. **Version control configs** - Track theme changes in your repository

...
1. **Container** - Shows applications, databases, and services within the system
1. **Component** - Shows internal structure of containers
1. **Code** - Class diagrams showing implementation details (use regular class diagrams)
...
1. **Keep it focused** - One system per Context diagram, one container per Component diagram
1. **Show key relationships** - Don't clutter with every possible connection
1. **Use consistent naming** - Same names across all diagram levels
1. **Add technology details** - Specify frameworks, languages, protocols at Container/Component level
1. **Update regularly** - Keep diagrams in sync with architecture
1. **Use boundaries** - Group related containers/components logically
1. **Document protocols** - Show communication methods (REST, gRPC, messaging)
1. **Highlight external systems** - Use \*\_Ext variants for clarity
1. **Start simple** - Begin with Context, drill down as needed
